...
import { RAISE_FAQS } from '../../content/raisePageContent'
    ...
    <section id="faq" className="bg-white px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-7 text-gray-600 sm:text-xl">{RAISE_FAQS.subtitle}</p>
        </div>

        <div className="mt-16 flex flex-col gap-4">
          {RAISE_FAQS.items.map((item, index) => {
